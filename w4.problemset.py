...
#
    ...
    while calculateHandlen(hand)>0:
        ...
        if inp =='.':
            print 'Goodbye! Total score:',puntosfinal,'points.'
            break
        else:
 
            if isValidWord(inp, hand, wordList) is True:
 
                puntosfinal=puntosfinal+getWordScore(inp, n)
 
                print '"'+inp+ '" earned',puntosfinal,'points. Total:',puntosfinal,'points'
                print
 
                hand=updateHand(hand, inp)
 
            elif isValidWord(inp, hand, wordList) is False:
 
                print'Invalid word, please try again.'
                print
           
 
    print 'Run out of letters. Total score:',puntosfinal,'points.'
